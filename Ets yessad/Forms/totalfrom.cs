...
{
    public partial class totalfrom : Form
    {
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "SELECT Total FROM StatsTable WHERE La_date BETWEEN @StartDate AND @EndDate";
                ...
                dbconnect.CloseCon();
                totallabel.Text = string.Format("{0:N2}", Convert.ToDouble(count.ToString()));
            }
